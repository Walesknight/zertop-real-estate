              ...
              <div>
                ...
                <div className="mt-5 flex items-start gap-3 text-gray-600">
                  ...
                  <p className="leading-7">
                    Odo Elewu Junction, off
                    Iloti Road, Epe, Lagos
                    State.
                  </p>
                </div>

                <p className="mt-6 leading-8 text-gray-600">
                  Hilltop Gardens is one of
                  Zertop Limited&apos;s
                  real-estate developments in
                  the Epe growth corridor,
                  designed around
                  accessibility,
                  infrastructure and
                ...
                <p className="mt-4 leading-8 text-gray-600">
                  The estate is positioned
                  close to educational
                  institutions, transport
                  links and other
                  developments within Epe,
                  providing potential
                  homeowners and investors
                  with access to a developing
                  area.
                </p>
              ...
              <div className="relative z-10 grid items-center gap-10 lg:grid-cols-[0.75fr_1.25fr]">
                ...
                <div>
                  ...
                  <p className="mt-5 max-w-2xl leading-8 text-gray-600">
                    ...
                    and estate features can
                    be published as project
                    information becomes
                    available.
                  </p>
